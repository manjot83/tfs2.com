...
namespace TFS.Intranet.Data.Billing{
    /// <summary>
    /// Strongly-typed collection for the BillingRatesJoin class.
    /// </summary>
    [Serializable]
    public partial class BillingRatesJoinCollection : ReadOnlyList<BillingRatesJoin, BillingRatesJoinCollection>
    {        
        public BillingRatesJoinCollection() {}

    }

    /// <summary>
    /// This is  Read-only wrapper class for the vw_BillingRates_Join view.
    /// </summary>
    [Serializable]
    public partial class BillingRatesJoin : ReadOnlyRecord<BillingRatesJoin> 
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_BillingRates_Join", TableType.View, DataService.GetInstance("Billing"));
                ...
                DataService.Providers["Billing"].AddSchema("vw_BillingRates_Join",schema);
            }
        ...
        public BillingRatesJoin(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public BillingRatesJoin(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
	    ...
	    public BillingRatesJoin(string columnName, object columnValue)
        {
            SetSQLProps();
