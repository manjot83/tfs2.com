<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FCIFPrintView.aspx.cs" Inherits="TFS.Web.Forms.FCIFPrintView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>FCIF Print View</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <th align="left">FCIF NUMBER</th>
            </tr>
            <tr>
                <td colspan="2" style="border: solid 1px black;"><%= file.GetStoredValue("Subject") %>&nbsp;</td>
                <td style="border: solid 1px black;"><%= file.GetStoredValue("FCIF Number") %>&nbsp;</td>
            </tr>
