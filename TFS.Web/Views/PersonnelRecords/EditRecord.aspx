...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset class="standard-form">
        ...
        <% using (Html.BeginForm(MVC.PersonnelRecords.EditPersonalInfo(), FormMethod.Post, new { @class = "fieldset-content" }))
           { %>
        ...
        <div class="field-group">
            <div class="field">
                ...
                <%= Html.TextBox("Email", Model.PersonalInfo.Email, new { size = "20", maxlength = "254" })%>
    ...
    <fieldset class="standard-form">
        ...
        <% using (Html.BeginForm(MVC.PersonnelRecords.EditContactInfo(), FormMethod.Post, new { @class = "fieldset-content" }))
           { %>
        <%= Html.Hidden("username", Model.Username) %>
        <%= Html.Hidden("editingmyrecord", Model.EditingMyRecord)%>
        <div class="field-group">
    ...
    <fieldset class="standard-form">
        <legend>TFS Company Information</legend>
